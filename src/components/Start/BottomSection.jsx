          ...
          <div className="lg:pr-10  md:bg-sky-50 py-80 pl-36 w-[70%] flex justify-center items-center">
            <div>
              ...
              <p className="mb-6 text-gray-600 sm:text-4xl text-2xl">
                Check out Gayatri’s story of <br /> finding a new job on
                CarrierConnect
              </p>
            </div>
          </div>
        ...
        <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-start lg:px-8">
          <div className=" text-center ltr:sm:text-left rtl:sm:text-right ">
            ...
            <div className="mt-8 flex flex-wrap gap-4 text-center">
              <button className="block w-full rounded-full bg-green-600 px-12 py-3 text-sm font-medium text-white shadow hover:bg-green-700 focus:outline-none focus:ring active:bg-green-500 sm:w-auto  ">
                Get Started
              </button>
            </div>
          </div>

  ...
  return (
    <div>
      ...
      {shuffledUsers.slice(0, visibleUsers).map((user) => (
        ...
        <li key={user.id} className="rounded-xl border border-gray-100 shadow-md bg-white mb-2  p-4">
        ...
        <button
  className="flex items-center justify-between gap-3 rounded-full  border border-current px-5 py-2 text-gray-500 transition-colors hover:bg-gray-100 focus:outline-none focus:ring active:bg-gray-500"
